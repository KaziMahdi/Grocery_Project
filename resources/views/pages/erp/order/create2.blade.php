            ...
            <div class="invoice p-3 mb-3">
              ...
              <div class="row">
                <div class="col-12">
                  <h4 style="text-align: center;">
                    ...
                    <button type="button" class="btn btn mt-2" style="background-color: #844FC1;color:aliceblue;margin-top:2px">Sales Form</button><br>
                  </h4>
                </div>
                <hr style="border:1px solid #844FC1; width:90%">
                <!-- /.col -->
              </div>
              <button id="showFormButton" class="btn btn-primary">Table-1</button>
              <button id="table2FormButton" class="btn btn-primary">Table-2</button>
              <button id="table3FormButton" class="btn btn-primary">Table-3</button>
              <button id="table4FormButton" class="btn btn-primary">Table-4</button>
              <button id="showFormButton" class="btn btn-primary">Table-5</button>
              <button id="showFormButton" class="btn btn-primary">Table-6</button>
              <button id="showFormButton" class="btn btn-primary">Table-7</button>
              <button id="showFormButton" class="btn btn-primary">Table-8</button>
              
              <!-- info row -->
              <form action="/orders" method="post" id="myForm" style="display: none;">
              ...
              <div class="row invoice-info" style="font-size:16px;">
                ...
                <div class="col-sm-4 invoice-col">
                  ...
                  Customer
                  <address>
                    <select id="cmbCustomer" name="customer_id">
                      @foreach($customers as $customer)
                      <option value="{{$customer->id}}">{{$customer->name}}</option>
                      @endforeach
                    </select>

                    <div id="customer-mobile"></div>
                ...
                <div class="col-sm-4 invoice-col">
                  ...
                  <table>
                    ...
                    <tr>
                      <td><b><i class="fa fa-circle  text-xs mr-1" style="color:#00a7c7"></i>Order Date:</b></td>
    ...
    <script>
      $(function() {
        ...
        $("#btnProcessOrder").on("click", function(e) {
          ...
          let order_total=$("#net-total").html();
        ...
        $("#cmbCustomer").on("change", function() {
          $.ajax({
            ...
            success: function(res) {
              ...
              $("#customer-mobile").html("<b>Mobile:</b>" + customer.mobile)
            }
          });
        });
        ...
        $("#cmbProduct").on("change", function() {
          $.ajax({
            ...
            success: function(res) {
              ...
              $("#txtPrice").val(product.salling_price);
...
@section('script')
  ...
  document.getElementById('table2FormButton').addEventListener('click', function() {
    document.getElementById('myForm').style.display = 'block';
  });
  document.getElementById('showFormButton').addEventListener('click', function() {
