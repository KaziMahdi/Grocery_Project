...
<div class="col-lg-12 grid-margin stretch-card">
        ...
        <div class="w-100 d-flex justify-content-between align-items-end">
          <h4 class="color-primary">Manage Purchase</h4>
          <input type="text" class="form-control" placeholder="Searche" id="serch" style="height: 40px;width: 30%;" onkeyup="search()">
          <a href="{{url('/purchases/create')}}" class="btn btn rounded" style="background-color:#9370DB;color:azure"><i class="fas fa-plus-circle mr-1"></i> Create new</a>
        </div>
      </div>
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>
                            ...
                            <a href="{{route('purchases.show',$purchase->id)}}" class="btn btn-success">View</a>
