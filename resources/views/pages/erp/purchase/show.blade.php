                                ...
                                <div class="col-xl-3 col-lg-3 col-md-12 col-sm-12 col-12">
                                    <div class="invoice-details">
                                        <div class="invoice-num">
                                            <div>Invoice:{{$purchase->id}}</div>
                                            <div>Issu Date:{{$purchase->delivery_date}}</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table custom-table m-0">
                                            ...
                                            @php
                                              ...
                                              $subtotal=0;
                                            @endphp
                                                @foreach($purchse_details as $purchse_detail)
                                                <tr>
                                                    <td>{{++$sn}}</td>                                    
                                                    <td>{{$purchse_detail->pname}}</td>
                                                    <td>{{$purchse_detail->measure}}</td>
                                                    <td>{{$purchse_detail->uname}}</td>
                                                    <td>{{$purchse_detail->price}}</td>
                                                    <?php 
                                                    $amount=$purchse_detail->measure*$purchse_detail->price-$purchse_detail->discount;
                                                    $subtotal+=$amount
                                                    ?>
                                                    <td>{{$amount}}</td>
                                                </tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <h5 class="text-success"><strong>{{$purchase->paid_amount}}</strong></h5>

                                                        <?php 
                                                        $due=$total-$purchase->paid_amount;
                                                        ?>
